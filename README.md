...
4. Install [hexnumgen](https://github.com/object-Object/hexnumgen-rs) by building a wheel for your system (see the README; `maturin build`) and running `pip install path/to/wheel`
