...
UNDOCUMENTED_PATTERNS = ResourceSet(
    values=[
        ...
        ResourceLocation("hexic", "conceptavailable"),
        ResourceLocation("hexic", "conceptremaining"),
        ...
        ResourceLocation("hexic", "mktunnel"),
